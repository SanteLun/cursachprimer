...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(249, 434);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(249, 500);
			...
			this->label5->Location = System::Drawing::Point(16, 500);
			this->label5->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(208, 27);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(16, 432);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(249, 277);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(249, 101);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(249, 32);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(273, 164);
			...
			this->label1->Size = System::Drawing::Size(55, 27);
			...
			this->ClientSize = System::Drawing::Size(645, 581);
